...
python -m ifcpatch -i 3C03_Geom_Kupittaa-Turku_patch_2.ifc -o 3C03_Geom_Kupittaa-Turku_patch_3.ifc -r PatchStationReferentPosition
python -m ifcpatch -i 3C03_Geom_Kupittaa-Turku_patch_3.ifc -o 3C03_Geom_Kupittaa-Turku_patch_4.ifc -r AddLinearPlacementFallbackPosition
...
python -m ifcpatch -i 3C03_Geom_TurkuAsema_patch_2.ifc -o 3C03_Geom_TurkuAsema_patch_3.ifc -r PatchStationReferentPosition
python -m ifcpatch -i 3C03_Geom_TurkuAsema_patch_3.ifc -o 3C03_Geom_TurkuAsema_patch_4.ifc -r AddLinearPlacementFallbackPosition
...
python -m ifcpatch -i BPaimio-Kupittaa_GK23_N2000_2020_patch_2.ifc -o BPaimio-Kupittaa_GK23_N2000_2020_patch_3.ifc -r PatchStationReferentPosition
python -m ifcpatch -i BPaimio-Kupittaa_GK23_N2000_2020_patch_3.ifc -o BPaimio-Kupittaa_GK23_N2000_2020_patch_4.ifc -r AddLinearPlacementFallbackPosition